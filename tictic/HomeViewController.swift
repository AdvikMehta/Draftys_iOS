...
//        ai.center = spinnerView.center
        ...
        loader = NVActivityIndicatorView(frame: CGRect(x: 0, y: 0, width: onView.frame.width, height: onView.frame.height), type: .circleStrokeSpin, color: .white, padding: onView.frame.width * 0.46)
        
        print("view.frame.width: ",onView.frame.width * 0.46)
