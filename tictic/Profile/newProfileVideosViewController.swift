//
//  newProfileVideosViewController.swift
//  TIK TIK
//
...
@available(iOS 13.0, *)
class newProfileVideosViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imgVideoTrimer.tag = indexPath.row
