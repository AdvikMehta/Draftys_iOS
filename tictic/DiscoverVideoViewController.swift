...
class DiscoverVideoViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        print(UserDefaults.standard.string(forKey: "dis_url")!)
        let url = URL.init(string: UserDefaults.standard.string(forKey: "dis_url")!)
        ...
        video_img.sd_setImage(with: URL(string:UserDefaults.standard.string(forKey: "dis_img")!), placeholderImage: UIImage(named:""))
    ...
    let longPressedGesture = UILongPressGestureRecognizer(target: self, action: #selector(handleLongPress(gesture:)))
            ...
            self.play_view.addGestureRecognizer(longPressedGesture)
    ...
    @IBAction func share(_ sender: Any) {
        ...
        let text =
        self.appDelegate.sharURl!+StaticData.obj.videoID
...
//            MARK:- JK
            ...
            vc.video_id = StaticData.obj.videoID!
