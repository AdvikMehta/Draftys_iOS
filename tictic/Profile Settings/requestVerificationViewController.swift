...
class requestVerificationViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        detailText.text = "A verification badge is check that appears next to an Draftys accounts name to indicate that the account is the authentic presence of notable public figure,celebrity,global brand or entitu it represents. \n\nSubmitting a requeset for verification does not guarantee that your account will be verified"
