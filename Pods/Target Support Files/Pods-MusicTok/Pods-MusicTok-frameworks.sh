...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ContentLoader/ContentLoader.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CoreAnimator/CoreAnimator.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KYShutterButton/KYShutterButton.framework"
